    ...
    if (bool) {
        ...
        array1.forEach(element => {
            if (!array2.includes(element)) {
                if (!unCommon.includes(element)) {
                    unCommon.push(element);
                }
            }
            array2.forEach (element2 => {
                if (!array1.includes(element2)) {
                    if (!unCommon.includes(element2)) {
                        unCommon.push(element2);
                    }
...
function main () {
    console.log(sets([1,2,3,3,4], [2,2,3,3,3,4,6], true));
    console.log(sets([1,2,3,3,4], [2,2,3,3,3,4,6], false));
}
main();